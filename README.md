...
- **[Deconstructing Student Achievement: Coupling Dimensionality Reduction with a Bayesian-Optimized SVM](https://steadows.github.io/svm_master.html)** *R, PCAmix, Cost-Sensitive SVM (RBF Kernel), Bayesian Optimization, Plotly* Developed a rigorous machine learning pipeline to predict high school academic success using high-dimensional, mixed-type survey data from the US Census Bureau.  
  - **Methodology:** Engineered a custom pipeline utilizing **PCAmix** to map the "mixed manifold" of numeric and categorical features, fed into a **Radial Basis Function SVM**.  
  - **Optimization:** Employed **Bayesian Optimization** to tune hyperparameters and class weights, successfully handling severe class imbalance to achieve a **90% recall rate** for at-risk students.  
  - **Key Insight:** Uncovered the "Reactive Paradox," statistically demonstrating that high-intensity parental help is often a lagging indicator of struggle, whereas independent study routines drive success.
